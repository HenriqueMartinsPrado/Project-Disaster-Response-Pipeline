...
def load_data(messages_filepath, categories_filepath):
    ...
    output:
        df: The merged dataset that contains the whole data
    '''
...
def clean_data(df):
    '''
    input:
        df: The merged dataset mentioned one step back (The merged dataset that contains the whole data)
    output:
        df: Dataset after process to clean
    '''
